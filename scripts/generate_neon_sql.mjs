// scratch/generate_neon_sql.mjs - Generate consolidated clean PostgreSQL script for Neon
import fs from 'fs';
...
fs.writeFileSync('scripts/neon_master_setup.sql', sql, 'utf8');
console.log('✓ Created scripts/neon_master_setup.sql successfully!');
