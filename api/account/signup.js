...
export default async function (req, res) {
  ...
  try {
    ...
    await db.query(
      ...
      [newUser.id, bio || 'Excited to share knowledge and acquire new skills on SkillSwap!', location || 'Remote / Worldwide']
    );
    ...
    await db.query(
      `INSERT INTO notifications (user_id, type, title, message, link)
       VALUES ($1, 'SYSTEM', 'Welcome to SkillSwap! 🎉', 'Complete your quick onboarding to start receiving reciprocal peer matches.', '/onboarding')`,
      [newUser.id]
    );
