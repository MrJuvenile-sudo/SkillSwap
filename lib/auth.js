      ...
      if (rows[0]) {
        await db.query(
          `INSERT INTO profiles (user_id, bio, location, preferred_language, availability, timezone)
           VALUES ($1, 'Passionate student and peer learner at Jabalpur Engineering College, India.', 'Jabalpur, Madhya Pradesh, India', 'English, Hindi', 'Flexible Evenings (IST)', 'IST (UTC+5:30)')
